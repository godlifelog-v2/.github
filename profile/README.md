...
| 레포 | 설명 | 기술 스택 |
|---|---|---|
| [backend](https://github.com/godlifelog-v2/backend) | REST API 서버 | Java, Spring Boot, MyBatis, Redis |
| [frontend](https://github.com/godlifelog-v2/frontend) | 모바일 웹 클라이언트 | React |
| [frontend-app](https://github.com/godlifelog-v2/frontend-app) | 앱뷰 웹 클라이언트 | Next.js |
